const Video = () => {
  return (
    <>
      <div className="grid grid-cols-5  max-sm:grid-cols-1 gap-3">
        <div className="bg-[#ddd]  rounded-xl hover:rounded-none transition-all duration-200 cursor-pointer shadow-xl w-fit max-sm:w-full max-sm:my-5 h-fit">
          <div>
            <img
